              ...
              >
                <div
                  className={cn(
                    ...
                    message.role === "user"
                      ? "bg-gradient-to-b from-gold-soft to-gold text-black"
        ...
        <div className="mb-3 flex flex-wrap gap-2">
          {QUICK_PROMPTS.map((prompt) => (
            <button
              ...
              disabled={isLoading}
              className="rounded-full border border-gold/20 bg-gold/5 px-3 py-1 text-xs text-gold-soft transition-colors hover:bg-gold/10 disabled:opacity-50"
            >
              {prompt}
            </button>
          ))}
