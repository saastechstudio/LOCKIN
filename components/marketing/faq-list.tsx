...
export const SUBSCRIPTION_FAQ: FaqItem[] = [
  ...
  },
  {
    ...
    answer:
      "Les paiements sont traités par Whop, plateforme spécialisée dans les abonnements aux communautés en ligne. Lock In ne stocke jamais tes coordonnées bancaires. Tes données membre restent privées et ne sont jamais revendues.",
  },
  {
